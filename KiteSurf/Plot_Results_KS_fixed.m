function Plot_Results_KS_fixed(T, RBE, rk, vk, ak, euler, omega, omega_p, Lambda, FAP, FAM, MAP, MAM, FBP, FBM, MBP, MBM,...
                         FA, MA, W, alfa, beta,Rp, Rm, Elong_p, Elong_m,xc,Error0 ,Flag_Dim,Flag_Plot)

%-----------------------------------------------------------------------------
% Edited 4/10/2022 by Benjamin Tummon, Undergraduate Engineer QUT            %
% Project   : Kite Control for Green Energy                                  %
% Changes   : Added Titles to Figures for better interpretation of results   %
%-----------------------------------------------------------------------------
%-----------------------------------------------------------------------------
% Project   : LAKSA                                                          %
...
if Flag_Plot(1) == 1 % Plot Position               %%
    ...
    figure(101)
    subplot(3,1,1)
    title("Earth Components of Position Vector (rk) across time (T)") % added by Ben Tummon 4/10/2022
    hold on
    plot(T,rk(1,:))
    ...
    figure(102)
    subplot(2,1,1)
    title("Kite Height (H)") % added by Ben Tummon 4/10/2022
    hold on
    hold on
    plot(rk(2,:),-rk(3,:))
...
if Flag_Plot(2) == 1 %Plot velocity               %%
    ...
    figure(103)
    subplot(3,1,1)
    title("Earth Components of Velocity Vector (vk) across time (T)") % added by Ben Tummon 4/10/2022
    hold on
    plot(T,vkb(1,:))
    xlabel(['$Time\ ' Unit_Time],'fontsize',12,'interpreter','latex' )
    ...
    figure(1003)
    subplot(3,1,1)
    title("Earth Componenets of Acceleration Vector (aK) across time (T)") % added by Ben Tummon 4/10/2022
    hold on
    plot(T,akb(1,:),'b-')
    xlabel(['$Time\ ' Unit_Time],'fontsize',12,'interpreter','latex' )
    ...
    figure(8003)
    subplot(3,1,1)
    title("Angular Acceleration (alpha) across time (T)") % added by Ben Tummon 4/10/2022
    hold on
    plot(T,Alp(1,:),'b-')
    xlabel(['$Time\ ' Unit_Time],'fontsize',12,'interpreter','latex' )
...
if  Flag_Plot(3) == 1 %Plot Euler Angles           %%
    ...
    figure(104)
    subplot(3,1,1)
    title("Euler Angles (psi,theta,phi) across time (T)") % added by Ben Tummon 4/10/2022
    hold on
    plot(T,euler(1,:))
    xlabel(['$Time\ ' Unit_Time],'fontsize',12,'interpreter','latex' )
...
if Flag_Plot(4) == 1 %Plot alfa and beta          %%
    figure(105)
    subplot(2,1,1)
    title("Alfa & Beta acorss time (T)") % added by Ben Tummon 4/10/2022
    hold on
    plot(T,alfa)
    xlabel(['$Time\ ' Unit_Time],'fontsize',12,'interpreter','latex' )
...
if Flag_Plot(5) == 1 %% Plot inelastic Tether tensions        %%
    ...
    figure(1061)
    subplot(3,1,1)
    title("Earth Components of Tension at A+ across time (T)") % added by Ben Tummon 4/10/2022
    hold on
    plot(T,T_Ap(1,:))
    xlabel(['$Time\ ' Unit_Time],'fontsize',12,'interpreter','latex' )
...
if Flag_Plot(6) == 1 %% Plot Control        %%
    figure(107)
    subplot(2,1,1)
    title("Control Vectors across time (T)") % added by Ben Tummon 4/10/2022
    hold on
    plot(T,xc(1,:))
    xlabel(['$Time\ ' Unit_Time],'fontsize',12,'interpreter','latex' )
...
if Flag_Plot(8) == 1 %% Tension of elastic tether   %%
    ...
    figure(1081)
    subplot(4,1,1)
    title("Earth Components of Tension at B+ across time (T)") % added by Ben Tummon 4/10/2022
    hold on
    plot(T,T_Bp(1,:))
    xlabel(['$Time\ ' Unit_Time],'fontsize',12,'interpreter','latex' )
...
if Flag_Plot(9) == 1 %% Elongation   %%
    ...
    figure(109)
    subplot(2,1,1)
    title("Elongation at B+ & B- across time (T)") % added by Ben Tummon 4/10/2022
    hold on
    plot(T,Elong_p)
    xlabel(['$Time\ ' Unit_Time],'fontsize',12,'interpreter','latex' )
...
if Flag_Plot(11) == 1 %% Error -> comparison with F = ma and dL/dt = M   %%
    figure(111)
    title("Error across time (T)") % added by Ben Tummon 4/10/2022
    hold on
    semilogy(T,Error0)
    xlabel(['$Time\ ' Unit_Time],'fontsize',12,'interpreter','latex' )
...
if Flag_Plot(12) == 1 %% SB-Components of the angular velocity
    ...
    figure(112)
    subplot(3,1,1)
    title("Earth Components of Angular Velocity across time (T)") % added by Ben Tummon 4/10/2022
    hold on
    plot(T, omega_B(1,:))
    xlabel(['$Time\ ' Unit_Time],'fontsize',12,'interpreter','latex' )
