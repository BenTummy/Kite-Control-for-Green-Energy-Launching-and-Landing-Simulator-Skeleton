function [xc xc_p xc_pp] = Fun_Control_KS_LaunchLand(t,X,PND,rk,vk,ak)
%-----------------------------------------------------------------------------
% Edited 18/10/2022 by Benjamin Tummon, Undergraduate Engineer QUT           %
% Project   : Kite Control for Green Energy                                  %
% Changes   : Added skeleton for programming launching and landing control   %
%-----------------------------------------------------------------------------
%-----------------------------------------------------------------------------
% Project   : LAKSA                                                          %
...
if PND.Ctr.Type==4 %Launching Kite from Ground (if-statement added by Ben Tummon 18/10/2022)

    %!!PROGRAM LAUNCHING CONTROL HERE!!

end

if PND.Ctr.Type==5 %Landing Kite to Ground (if-statement added by Ben Tummon 18/10/2022)

   %!!PROGRAM LANDING CONTROL HERE!!
